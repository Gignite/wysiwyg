...
(function() {
  ...
  Wysiwyg = (function() {
    ...
    Wysiwyg.prototype.availableItems = {
      'bold': 'Bold',
      'italic': 'Italic',
      'list': 'List',
      'link': 'Link',
    ...
    Wysiwyg.prototype.render = function() {
      ...
      if ((_ref = this.items) == null) {
        this.items = ['bold', 'italic', 'list', 'link', 'h2', 'h3'];
      }
      this.el.empty();
      _ref1 = this.items;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        item = _ref1[_i];
        this.el.append("<a href=\"#\" data-type=\"" + item + "\">" + this.availableItems[item] + "</a>");
      }
      return this;
    };
